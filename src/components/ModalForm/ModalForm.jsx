...
//   const [modalIsOpen, setIsOpen] = useState(true); // Відкриваємо вікно при завантаженні
...
//               Згоден з <a href="/privacy-policy">Політика конфіденційності</a>{" "}
//               та <a href="/terms-of-service">Умови користування послугами</a>
//             </p>
//           </div>
//           <button
//             type="submit"
